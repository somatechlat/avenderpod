...
def seed_database():
    ...
    for k, v in configs.items():
        cursor.execute(
            "INSERT OR REPLACE INTO tenant_config (key, value) VALUES (?, ?)", (k, v)
        )
    ...
    items = [
        (
            ...
            '{"calories": 800, "category": "food"}',
        ),
        (
            "Hamburguesa Doble",
            7.50,
            "Doble carne, doble queso, tocino.",
            '{"calories": 1200, "category": "food"}',
        ),
        (
            "Papas Fritas",
            2.50,
            "Porción grande de papas crujientes.",
            '{"calories": 400, "category": "sides"}',
        ),
        (
            "Gaseosa Cola",
            1.50,
            "Bebida azucarada 500ml.",
            '{"calories": 200, "category": "drinks"}',
        ),
    ]

...
class State:
    ...
    def __init__(self, agent: Agent):
        self.agent = agent
        self.browser_session: Optional[Any] = None
        self.task: Optional[defer.DeferredTask] = None
        self.use_agent: Optional[Any] = None
    ...
    def kill_task(self):
        ...
        if self.browser_session:
            try:
                ...
                if self.browser_session and hasattr(self.browser_session, "kill"):
                    loop.run_until_complete(self.browser_session.kill())
...
def get_use_agent_log(use_agent: Any | None):
